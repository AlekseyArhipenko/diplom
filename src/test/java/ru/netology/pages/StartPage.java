...
public class StartPage {
    ...
    public void checkNotificationApprovedVisible() {
        notificationApproved.shouldBe(Condition.not(Condition.visible));
    }

    public void checkNotificationDeclinedNotVisible() {
        notificationDeclined.shouldBe(Condition.not(Condition.visible));
    }
    ...
    public void checkNotificationApprovedNotVisible() {
        notificationApproved.shouldBe(Condition.visible);
    }
